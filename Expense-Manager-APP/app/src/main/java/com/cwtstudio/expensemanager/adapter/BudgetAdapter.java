...
public class BudgetAdapter extends RecyclerView.Adapter<BudgetAdapter.TransViewHolder>
{
    ...
    @Override
    public void onBindViewHolder(@NonNull BudgetAdapter.TransViewHolder holder, int position)
    {
